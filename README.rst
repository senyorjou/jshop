...
.. code-block:: bash
    ...
    heroku run python jshop/manage.py syncdb --noinput --settings=config.settings
    heroku run python jshop/manage.py migrate --settings=config.settings
    heroku run python jshop/manage.py collectstatic --settings=config.settings
